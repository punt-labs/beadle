...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/7f0dc0f/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/7f0dc0f/install.sh -o install.sh
cat install.sh
sh install.sh
```
