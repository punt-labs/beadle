...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/c0c1a19/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/c0c1a19/install.sh -o install.sh
cat install.sh
sh install.sh
```
