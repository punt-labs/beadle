...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/aa27b78/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/aa27b78/install.sh -o install.sh
cat install.sh
sh install.sh
```
