...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/393ae89/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/393ae89/install.sh -o install.sh
cat install.sh
sh install.sh
```
