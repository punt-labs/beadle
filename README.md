...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/c83a401/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/c83a401/install.sh -o install.sh
cat install.sh
sh install.sh
```
