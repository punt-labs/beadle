...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/2bf86b2/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/2bf86b2/install.sh -o install.sh
cat install.sh
sh install.sh
```
