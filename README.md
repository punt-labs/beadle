...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/8eb832a526d89bd5051763b20bcebbd88f90cc33/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/8eb832a526d89bd5051763b20bcebbd88f90cc33/install.sh -o install.sh
cat install.sh
sh install.sh
```
