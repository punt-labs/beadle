...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/4cd53fe/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/4cd53fe/install.sh -o install.sh
cat install.sh
sh install.sh
```
