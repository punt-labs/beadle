...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/601d59a/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/601d59a/install.sh -o install.sh
cat install.sh
sh install.sh
```
