...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/INSTALL_SHA/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/beadle/INSTALL_SHA/install.sh -o install.sh
cat install.sh
sh install.sh
```
